...
public class GlobalResourceCleaner : EditorWindow
{
    ...
    {
        string[] patterns = {"_CameraDepthAttachment_", "_CameraDepthTexture_","Camera","_SSAO", "DBufferDepth_" ,"DBufferTexture","AfterPostProcessTexture","CameraOpaqueTexture"}; // 模式列表
