...
namespace MeadowGames.UINodeConnect4
{
    public class InputManager_LegacyInputSystem : InputManager
    {
       ...
       public override Vector3 ScreenPointerPosition => Input.mousePosition;
        //public override Vector3 ScreenPointerPosition =>interactCamera.ScreenToWorldPoint(new Vector3(Input.mousePosition.x,Input.mousePosition.y,100f)) ;
        ...
        public override Vector3 GetCanvasPointerPosition(GraphManager graphManager)
        {
            ...
            else 
            {
                ...
                //screenPoint.z = graphManager.transform.position.z - interactCamera.transform.position.z;
               //return interactCamera.ScreenToWorldPoint(new Vector3(Input.mousePosition.x, Input.mousePosition.y, 100f);
